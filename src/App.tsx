        ...
        <Routes>
          ...
          <Route path="*" element={
            <div style={{ textAlign: 'center', padding: '120px 24px 80px', minHeight: '60vh' }}>
              ...
              <a href="/store/" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '14px 32px', background: '#005969', color: '#fff', fontSize: '12px', fontWeight: 600, textTransform: 'uppercase' as any, letterSpacing: '0.1em', textDecoration: 'none' }}>Back to Home</a>
            </div>
          } />
        </Routes>
      </main>
